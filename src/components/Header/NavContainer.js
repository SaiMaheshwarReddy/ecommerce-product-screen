...
setNavOpen(!navOpen)
    ...
    return (
       <Flex justifyContent={["flex-start", "flex-start", "flex-start","flex-start"]} width="100%" alignItems="center" ml="0.6rem" height="100%">
            ...
            {navOpen ?   <Image src={closeMenuIcon} width={["20px", "18px"]} /> : <Image src={openMenuIcon} width={["22px", "20px"]} />}
            ...
            <Box>
            <Image src={logoImg} ml={["0.95rem", "1.3rem", "0.5rem"]} width={["120px", "125px", "145px"]} />
            </Box>
